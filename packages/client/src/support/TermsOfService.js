...
function TermsOfService() {
  return (
    <Layout>
      <div className="terms-of-service col-8">
        <Style>
          {`
          .amplify-app .content {
            height: auto;
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Variable., No. 21, Lane 285, Minyou
              road, Qingshui district, Taichung City 436.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Amplify, accessible from{' '}
              <a
                href="https://amplifyyourskills.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://amplifyyourskills.com
              </a>
            </p>
          </li>
          <li>
        ...
        <p>
          ...
          USD if You have not purchased anything through the Service.
        </p>
        <p>
        ...
        <ul>
          <li>By email: jared.scott@variable.team</li>
        </ul>
      </div>
    </Layout>
  );
